...
public class CommandsController {
     ...
     * @param commandArgs Argumants of command
     ...
     */
    public UserCommand launchCommand(String commandName, String[] commandArgs) throws RecursiveScriptException, InvalidDataException, FileNotFoundException {
